...
getNewAccount = function(lastName, firstName, email, phoneNumber, associationId, antenneId, password){
  var newAccount = getNewBenevole(lastName, firstName, email, phoneNumber, associationId, antenneId);
